...
class WebSocketServer:
    ...
    async def handle_join(self, websocket: websockets.WebSocketServerProtocol, data: dict) -> None:
    ...
    async def handle_chat(self, websocket: websockets.WebSocketServerProtocol, data: dict) -> None:
    ...
    async def handle_status(self, websocket: websockets.WebSocketServerProtocol, data: dict) -> None:
    ...
    async def handle_disconnect(self, websocket: websockets.WebSocketServerProtocol) -> None:
    ...
    async def heartbeat(self, websocket: websockets.WebSocketServerProtocol) -> None:
    ...
    async def handle_pong(self, websocket: websockets.WebSocketServerProtocol) -> None:
        """Update last_pong time when pong is received"""
        if websocket in self.clients:
            self.clients[websocket].last_pong = asyncio.get_event_loop().time()

    async def message_handler(self, websocket: websockets.WebSocketServerProtocol, message: str) -> None:
    ...
    async def connection_handler(self, websocket: websockets.WebSocketServerProtocol) -> None:
